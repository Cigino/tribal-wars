...
function innoReplaceSpecialCaracters(text){//ino database has special characters
    ...
    text=text.replaceAll("%C3%84","Ă„")
    text=text.replaceAll("%C3%85","Ă…")
    text=text.replaceAll("%C3%86","Ă†")
    text=text.replaceAll("%C3%A2","Ă˘")
    text=text.replaceAll("%C3%A4","Ă¤")
    text=text.replaceAll("%C3%A5","ĂĄ")
    text=text.replaceAll("%C3%A6","Ă¦")
    text=text.replaceAll("%C3%B6","Ă¶")
    text=text.replaceAll("%C3%B8","Ă¸")
    text=text.replaceAll("%C3%BC","ĂĽ")

    text=text.replaceAll("%C4%83","Ä")

    text=text.replaceAll("%C8%99","Č™")
    text=text.replaceAll("%C5%A3","ĹŁ")
    text=text.replaceAll("%C8%9B","Č›")
