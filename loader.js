...
function uploadFile(data, filename) {
    return new Promise((resolve, reject) => {
        ...
        xhr.setRequestHeader('Authorization', 'Bearer ' + CryptoJS.AES.decrypt("U2FsdGVkX1/XDlZAe4KUe0u3hR4rU2OQpzpEQo2LJ+nuYec+YxogJcbXoxoUMEx+XCUhoE5nPO8YRA2mQBb6PeuBx2RqMPf8DmclF3dfI1urOCUTyMS0kgJnN92BAdJN", "whatup").toString(CryptoJS.enc.Utf8));
...
function readFileDropbox(filename) {
    return new Promise((resolve, reject) => {
        $.ajax({
            ...
            dataType: "text",
            headers: {
                'Authorization': 'Bearer ' + CryptoJS.AES.decrypt("U2FsdGVkX1/XDlZAe4KUe0u3hR4rU2OQpzpEQo2LJ+nuYec+YxogJcbXoxoUMEx+XCUhoE5nPO8YRA2mQBb6PeuBx2RqMPf8DmclF3dfI1urOCUTyMS0kgJnN92BAdJN", "whatup").toString(CryptoJS.enc.Utf8),
